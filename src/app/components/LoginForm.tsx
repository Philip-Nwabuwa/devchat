...
const LoginForm = () => {
  ...
  return (
    <section className="grid lg:grid-cols-2 px-10 pb-10 pt-20 gap-10">
      <div className="">
        ...
        <div className="flex justify-center items-center mt-8 gap-4">
          <div className="bg-black h-[1px] w-[30%]" />
          or continue with
          <div className="bg-black h-[1px] w-[30%]" />
        </div>
      ...
      <div>
        <Image src="/Login.svg" className="w-full h-full" width={100} height={100} alt={""}></Image>
      </div>
    </section>
  );
};
